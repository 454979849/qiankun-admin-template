...
export async function bootstrap() {
  console.log('sub-react bootstraped');
}
/**
 * 应用每次进入都会调用 mount 方法，通常我们在这里触发应用的渲染方法
 */
export async function mount(props:any) {
  console.log('sub-react 收到基座下发的能力：', props);
  props.actions.onGlobalStateChange((state:any, prev:any) => {
    // state: 变更后的状态; prev 变更前的状态
    console.log('sub-react 子应用监听到共享状态改变了：',state, prev);
...
export async function unmount(props:any) {
  console.log('sub-react unmount props',props);
